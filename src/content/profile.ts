  ...
  skillCategories: [
    {
      ...
      skills: [
        ...
        { name: "Rust", level: "advanced", yearsUsed: 3 },
        { name: "Go", level: "advanced", yearsUsed: 4 },
        { name: "React/Next.js", level: "expert", yearsUsed: 5 },
        { name: "Node.js", level: "expert", yearsUsed: 5 },
        { name: "PostgreSQL", level: "advanced", yearsUsed: 4 },
        { name: "GraphQL", level: "advanced", yearsUsed: 3 },
      ],
    },
    {
      name: "Cybersecurity",
      ...
      skills: [
        ...
        { name: "Reverse Engineering", level: "advanced", yearsUsed: 3 },
        { name: "Malware Analysis", level: "intermediate", yearsUsed: 2 },
        { name: "Network Security", level: "advanced", yearsUsed: 4 },
        { name: "Cryptography", level: "advanced", yearsUsed: 3 },
        { name: "Incident Response", level: "advanced", yearsUsed: 3 },
    ...
    },
    {
      ...
      skills: [
        { name: "LLM Integration", level: "advanced", yearsUsed: 2 },
        { name: "RAG Systems", level: "advanced", yearsUsed: 2 },
        { name: "ML Pipelines", level: "intermediate", yearsUsed: 2 },
        { name: "Agent Frameworks", level: "advanced", yearsUsed: 1 },
